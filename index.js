...
app.get("/inscription/:fname/:lname/:age/:ad/:tel/:Em", (req, res) => {
  www
    .inscription(
      req.params.fname,
      req.params.lname,
...
app.get("/CheckUpdateInscription/:id_client/:id_bloc/:N_mounth", (req, res) => {
  www
...
app.get("/inscription_bloc/:id_client/:id_bloc/:num_mounth", (req, res) => {
  www
    .inscription_bloc(
      req.params.id_client,
      req.params.id_bloc,
...
app.get("/accessToRoom/:id_client/:id_bloc", (req, res) => {
  www
    .getToRoom(
      req.params.id_client,
      req.params.id_bloc
...
app.get("/accessToGym/:id_client", (req, res) => {
  www
    .getToGym(
      req.params.id_client
      //   req.params.end_mem,
    ...
    .then((z) => {
      ...
      res.redirect("/saveTimeEnter/" + req.params.id_client);
    })
    .catch((e) => {
...
app.get("/saveTimeEnter/:id_client", (req, res) => {
  www
...
app.get("/allTheClientIns", (req, res) => {
  www
    .getTheClientListIns()
    .then((ree) => {
...
app.get("/infoClientById/:idClient", (req, res) => {
  www
...
app.get("/getBlocRegistredByOneClient/:idClient", (req, res) => {
  www
...
// add a bloc
app.get("/addBloc/:name/:des", (req, res) => {
  www
...
app.get("/saveTimLeave/:id_client", (req, res) => {
  www
